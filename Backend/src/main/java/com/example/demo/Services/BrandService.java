...
public class BrandService {
    ...
    public List<Brand> getBrandsByChain(@NonNull Long chainId) {
    ...
    public List<Brand> getBrandsByGroup(@NonNull Long groupId) {
    ...
    // Get brand by id
    public Optional<Brand> getBrandById(@NonNull Long brandId) {
        return brandRepository.findById(brandId);
    }

    // Add new brand
    public Brand addBrand(Brand brand, @NonNull Long chainId) {
    ...
    // Update brand
    public Brand updateBrand(@NonNull Long brandId, Brand updatedBrand, @NonNull Long chainId) {
        ...
        // Check if updated brand name already exists for another brand with the same
        // chain
    ...
    public boolean canDeleteBrand(@NonNull Long brandId) {
