...
public class ZoneService {
    ...
    public List<Zone> getZonesByBrand(@NonNull Long brandId) {
    ...
    public List<Zone> getZonesByChain(@NonNull Long chainId) {
    ...
    public List<Zone> getZonesByGroup(@NonNull Long groupId) {
        return zoneRepository.findByBrand_Chain_GroupGroupIdAndIsActiveTrue(groupId);
    }

    // Get zone by id
    public Optional<Zone> getZoneById(@NonNull Long zoneId) {
        return zoneRepository.findById(zoneId);
    }

    // Add new zone
    public Zone addZone(Zone zone, @NonNull Long brandId) {
    ...
    // Update zone
    public Zone updateZone(@NonNull Long zoneId, Zone updatedZone, @NonNull Long brandId) {
    ...
    public void deleteZone(@NonNull Long zoneId) {
