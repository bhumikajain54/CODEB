...
public class InvoiceService {
    ...
    @Transactional
    public Invoice generateInvoice(@NonNull Long estimateId, String emailId, Float amountPaid) {
        // Find the estimate
    ...
    public Invoice updateInvoice(@NonNull Long id, String emailId) {
    ...
    public byte[] generateInvoicePdf(@NonNull Long id) {
        Invoice invoice = invoiceRepository.findById(id)
