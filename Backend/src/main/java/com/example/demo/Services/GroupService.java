...
public class GroupService {
    ...
    public Optional<Group> getGroupById(@NonNull Long groupId) {
    ...
    public Group updateGroup(@NonNull Long id, String newName) {
...
//        }
//    }
    public void softDeleteGroup(@NonNull Long id) {
