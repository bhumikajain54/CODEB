...
public class EstimateService {
    ...
    // Get estimate by id
    public Optional<Estimate> getEstimateById(@NonNull Long estimateId) {
        return estimateRepository.findById(estimateId);
    }

    // Get estimates by chain id
    public List<Estimate> getEstimatesByChainId(@NonNull Long chainId) {
    ...
    public Estimate createEstimate(Estimate estimate, @NonNull Long chainId) {
        // Find the chain
    ...
    // Update an estimate
    public Estimate updateEstimate(@NonNull Long estimateId, Estimate updatedEstimate, Long chainId) {
    ...
    // Delete an estimate
    public void deleteEstimate(@NonNull Long estimateId) {
