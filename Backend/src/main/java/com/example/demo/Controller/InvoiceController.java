...
public class InvoiceController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Object> getInvoiceById(@PathVariable @NonNull Long id) {
    ...
    public ResponseEntity<?> generateInvoice(@RequestBody Map<String, Object> requestData) {
        try {
            long estimateId = Long.parseLong(requestData.get("estimateId").toString());
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteInvoice(@PathVariable @NonNull Long id) {
        try {
    ...
    @GetMapping("/{id}/pdf")
    public ResponseEntity<byte[]> getInvoicePdf(@PathVariable @NonNull Long id) {
        try {
