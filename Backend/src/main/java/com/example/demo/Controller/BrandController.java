...
public class BrandController {
    ...
    public List<Brand> getBrandsByChain(@PathVariable @NonNull Long chainId) {
        return brandService.getBrandsByChain(chainId);
    }

    @GetMapping("/group/{groupId}")
    public List<Brand> getBrandsByGroup(@PathVariable @NonNull Long groupId) {
        return brandService.getBrandsByGroup(groupId);
    }

    @GetMapping("/{id}")
    public ResponseEntity<?> getBrandById(@PathVariable @NonNull Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateBrand(@PathVariable @NonNull Long id, @RequestBody Brand brand, @RequestParam @NonNull Long chainId) {
        try {
    ...
    public ResponseEntity<Boolean> canDeleteBrand(@PathVariable @NonNull Long id) {
